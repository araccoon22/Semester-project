---
title: "Swissmetro 2 try - 100 draws BFGS"
...
Because of random coefficients issues, we are trying to just have 2 random coefficients in this model.
They are defined for time and cost.
...
apollo_draws = list(
  ...
  interNDraws    = 100,
  interUnifDraws = c(),
  interNormDraws = c("draws_t", "draws_c"),  #Standard Normal dist draws
